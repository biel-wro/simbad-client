                ...
                (a.prototype.init = function(t, e) {
                    ...
                    (a.prototype.setupHandlers = function() {
                        ...
                        for (var i in this.eventListeners)
                            ...
                            ).addEventListener(i, this.eventListeners[i], !1);
                ...
                var u = [],
                    h = function(t, e) {
                        ...
                        for (var n = u.length - 1; n >= 0; n--)
                            if (u[n].svg === o)
                                return u[n].instance.getPublicInstance();
                        return (
                            u.push({
                                svg: o,
                                instance: new a(o, e)
                ...
                document.documentMode && (n = 'ie'),
                    (e.exports = {
                        ...
                        getOrCreateViewport: function(t, e) {
                            var n = null;
                            if (
                                ((n = o.isElement(e) ? e : t.querySelector(e)),
                                !n)
                            ) {
                        ...
                        if (void 0 === t.clientX || null === t.clientX)
                            if (
                                ...
                                if (void 0 !== t.changedTouches[0].clientX)
                                    ...
                                    (t.clientX =
                                        t.changedTouches[0].pageX - o.left),
                                        (t.clientY =
                                            t.changedTouches[0].pageY - o.top);
                                }
                            } else
                    ...
                    createRequestAnimationFrame: function(t) {
                        ...
                        return (
                            'auto' !== t &&
                                ...
                                (e = Math.floor(1e3 / t)),
                            null === e
                                ? window.requestAnimationFrame || o(33)
                                : o(e)
                        );
                    }
                };
