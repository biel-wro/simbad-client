...
import { ConfigurationFormState } from '@simbad-simulation/lib/configuration-editor/store/form.model';
import { SimulationPipelineState } from '@simbad-simulation/lib/simulation-pipeline/core/store/simulation/simulation-pipeline.reducer';
