...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<simbad-big-input-action></simbad-big-input-action>';
  ...
  it('should emit action event on button click', () => {
    const template = `<simbad-big-input-action (action)="actionHandler()"></simbad-big-input-action>`;
    fixture = createHostComponent(template);
