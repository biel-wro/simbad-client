...
describe('ObjectsDefinitionsService', () => {
    ...
    it('should be created', () => {
        const service: ObjectsDefinitionsService = TestBed.get(
    ...
    describe('getByClassName', () => {
        it('should return correct definition for root parameter', () => {
            ...
            expect(parameter.possibleClasses).toContain(
    ...
    describe('toParameterTreeNode', () => {
        it('should return valid parameter tree for root parameter', () => {
            ...
            expect(tree.complexChildren[0].definition.className).toEqual(
                'final_estimator'
            );
        });
        ...
        it('should return valid parameter tree for complex parameter', () => {
            ...
            expect(tree.complexChildren[1].definition.className).toEqual(
                'saturation'
            );
            expect(tree.complexChildren[2].definition.className).toEqual(
                'mutator'
            );
        });
